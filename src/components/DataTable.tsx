...
export const DataTable: React.FC<DataTableProps> = ({ data, onEdit, onOpenSelector }) => {
  ...
  return (
    <div style={{
      ...
      boxShadow: '0 2px 16px rgba(74,44,26,0.07)',
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '0.72rem', color: B[500], marginTop: 2, fontWeight: 500 }}>
            Unique PI transaction records
          </p>
        </div>
        <button style={{
          display: 'flex', alignItems: 'center', gap: '0.4rem',
          padding: '0.45rem 0.9rem', background: '#fff',
          border: `1.5px solid ${B[200]}`, borderRadius: '0.65rem',
          fontSize: '0.72rem', fontWeight: 700, color: B[700],
          cursor: 'pointer', fontFamily: 'DM Sans, sans-serif',
          transition: 'all 0.18s',
        }}
          onMouseEnter={e => { const b = e.currentTarget as HTMLButtonElement; b.style.background = B[800]; b.style.color = '#fff'; b.style.borderColor = B[800]; }}
          onMouseLeave={e => { const b = e.currentTarget as HTMLButtonElement; b.style.background = '#fff'; b.style.color = B[700]; b.style.borderColor = B[200]; }}>
            ...
            {uniqueRows.map((row, idx) => {
              ...
              return (
                <tr key={idx}
                  ...
                  {/* PI Value */}
                  <td style={{
                    padding: '0.85rem 1.1rem', textAlign: 'right',
                  ...
                  <td style={{
                    padding: '0.85rem 1.1rem', textAlign: 'right',
                    fontWeight: 700, color: '#dc2626', fontSize: '0.82rem',
                  ...
                  <td style={{
                    padding: '0.85rem 1.1rem', textAlign: 'right',
                    fontWeight: 700, color: '#b45309', fontSize: '0.82rem'
                  }}>
